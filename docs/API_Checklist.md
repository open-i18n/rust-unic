...
NOTE: The items are marked if (and only if) they apply to code in the project. If the item is
not applicable to current code, it's left unchecked, to be reviewed later if and when new
applicable code is added.
