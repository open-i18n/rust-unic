...
/// Ref: <http://www.unicode.org/Public/UCD/latest/ucd/auxiliary/SentenceBreakProperty.txt>
///
/// ```text
...
mod tests {
    ...
    #[test]
    fn test_abbr_name() {
        assert_eq!(SB::Other.abbr_name(), "XX");
    }

    #[test]
    fn test_long_name() {
        assert_eq!(SB::Other.long_name(), "Other");
    }

    #[test]
    fn test_human_name() {
        assert_eq!(SB::Other.human_name(), "Other");
    }

    #[test]
    fn test_display() {
        assert_eq!(format!("{}", SB::Other), "Other");
    }
}
